...
fn scroll_editor(
    ...
    let old_scroll_anchor = editor.scroll_manager.read(cx).anchor();
    ...
    let scroll_anchor = editor.scroll_manager.read(cx).anchor();
    ...
    editor.change_selections(
        ...
        |s| {
            s.move_with(|map, selection| {
                ...
                let top = scroll_anchor.top_display_point(map);
                ...
                if preserve_cursor_position {
                    let old_top = old_scroll_anchor.top_display_point(map);
                ...
                let min_column = match preserve_cursor_position {
                    true => old_scroll_anchor.top_display_point(map).column(),
                    false => top.column(),
                };
